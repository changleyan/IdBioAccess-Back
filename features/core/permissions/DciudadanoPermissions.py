...
class DciudadanoPermissions(permissions.BasePermission):

    def has_permission(self, request, view):
        usuario = request.user
        is_authenticated = usuario.is_authenticated

        # los permisos 'create', 'partial_update', 'update', 'destroy' no estan aki pq los ciudadanos son de solo lectura
